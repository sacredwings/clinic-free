...
export default function Add () {
    ...
    const OnClickAdd = async (e) => {
        ...
        let result = await ServerRoleAdd(form);
    ...
    function ModalWindow() {
        let modalContent = <>
            <div className="modal-header">
                <h5 className="modal-title" id="exampleModalLabel">+ Роль</h5>
    ...
    return <div className={'Add'}>
        <button className="btn btn-success btn-sm" type="button" onClick={OnClickModalShow}> + Добавить роль</button>
        {ModalWindow()}
    </div>
}