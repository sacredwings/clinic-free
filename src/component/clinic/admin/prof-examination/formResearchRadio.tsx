                    ...
                    <div className={"row"}>
                        <div className={"col-12"}>
                            <div className="form-check">
                                <input className="form-check-input" type="radio" name={`radio_${research._id}`} id={`radio_${research._id}_0`}
                            ...
                            <div className="form-check">
                                <input className="form-check-input" type="radio" name={`radio_${research._id}`} id={`radio_${research._id}_1`} value={0}
                            ...
                            <div className="form-check">
                                <input className="form-check-input" type="radio" name={`radio_${research._id}`} id={`radio_${research._id}_2`} value={1}
