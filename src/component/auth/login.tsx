...
export default function AuthLogin (props) {
    ...
    return <form onSubmit={onClickAuth}>
        ...
        {/*<a href={`https://oauth.vk.com/authorize?client_id=${config.vk.app.id}&display=page&redirect_uri=${config.vk.app.redirect_uri}&scope=email&response_type=code&v=5.131`} type="button" className="btn btn-primary">ВК</a>*/}&nbsp;
        <br/>
