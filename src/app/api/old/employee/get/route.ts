...
export async function GET(request: Request) {
    ...
    try {
        ...
        try {
            ...
            let items = await CEmployee.Get ( value.clinic_id, arFields )
            let count = await CEmployee.GetCount ( value.clinic_id, arFields )
        ...
        return NextResponse.json({...{code: 10000000, msg: 'REmployee Get'}, ...err})
    }
}
