...
export async function GET(request: Request) {
    ...
    try {
        ...
        try {
            ...
            let items = await CRoom.Get ( value.clinic_id, arFields )
            let count = await CRoom.GetCount ( value.clinic_id, arFields )
        ...
        return NextResponse.json({...{code: 10000000, msg: 'RRoom Get'}, ...err})
    }
}
