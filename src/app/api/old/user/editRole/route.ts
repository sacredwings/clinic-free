    ...
    try {
        try {
            ...
            const schema = Joi.object({
                ...
                role_ids: Joi.array().min(1).max(50).items(Joi.string().min(24).max(24)).allow(null).empty(Joi.array().length(0)).default(null),
            })
        ...
        try {
            ...
            let arFields = {
                role_ids: new DB().ObjectID(value.role_ids),
            }
